    ...
    <style>
        * {
        ...
        @media only screen and (max-width: 600px) {
            ...
            .greeting, .alert-box, .task-card, .cta-section {
                margin-left: 16px;
                margin-right: 16px;
            }
        }
...
<body>
    <div class="email-container">
        ...
        <div class="greeting">
            ...
            <p>Tienes una tarea que requiere atención inmediata:</p>
        </div>

        <!-- Alert Box -->
        <div class="alert-box">
            <strong>⚠️ Atención</strong>
            <span>Tienes una tarea que ha superado su fecha de vencimiento.@if($esAdmin) <br><strong>Notificación para administrador:</strong> Esta tarea requiere atención.@endif</span>
        </div>
        ...
        <div class="task-card">
            <div class="task-header">
                ...
                <span class="status-badge">{{ ucfirst($tarea->estado) }}</span>
            </div>
