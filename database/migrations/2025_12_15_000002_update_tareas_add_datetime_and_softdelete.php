...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE `tareas` MODIFY COLUMN `estado` ENUM('pendiente','en_progreso','completado','eliminado') DEFAULT 'pendiente'");
        
        // Agregar campos de fecha/hora como datetime
        // Migrar datos existentes y cambiar tipos
        DB::statement("ALTER TABLE `tareas` 
        ...
        // Migrar datos: convertir fechas a datetime (añadir hora)
        DB::statement("UPDATE `tareas` SET 
    ...
    public function down(): void
    {
        ...
        // Revertir enum
        DB::statement("ALTER TABLE `tareas` MODIFY COLUMN `estado` ENUM('pendiente','en_progreso','completado') DEFAULT 'pendiente'");
    }
};
